...
/* PART ONE - write functions that accomplish the following:
...
4- Take an array of strings, and a number and return an array of the 
   ...
   For example, stringsLongerThan(['say', 'hello', 'in', 'the', 
   'morning'], 3); would return ["hello", "morning"].

(don't need to do this one)
5- Take a number, n, and print every number between 1 and n without 
   using loops. Use recursion.
*/
...
// worked w Soumya, Toon, Fouad, Julian